...
export const UserSchema = new mongoose.Schema({ 
    ...
    gender: {  type: String, required: true, enum: Object.values(genderEnum), default: genderEnum.unspecified },
    roles: { type: [String], required: true, enum: Object.values(roleEnum), default: [roleEnum.user] },
    oauth2Source: { type: String, required: true, enum: Object.values(oauth2Source) },
    avatar: { type: String, required: false },
    selfInfo: { type: String, required: false },
    profilePrivatType: { type: String, reguired: false, enum: Object.values(profilePrivatType), default: profilePrivatType.open },
